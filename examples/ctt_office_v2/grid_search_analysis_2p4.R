...
track_df <- calculate_track(
  start_time = "2025-05-27 19:38:16",
  length_seconds = 170,
  step_size_seconds = 3,
  det_time_window = 12, # Must have detection within this window to be included in position calculation
  filter_alpha = 0.55,
...
sidekick_file_path <- "data/ctt_office_v2/sidekick/transect_1.csv"
